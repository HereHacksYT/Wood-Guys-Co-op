...
function init() {
    ...
    // 1. DENGELİ IŞIKLAR (Ne karanlık yapar ne patlatır, renkleri net gösterir)
    ...
    skyWallMesh = new THREE.Mesh(
        ...
        new THREE.MeshStandardMaterial({ map: skyTex, roughness: 0.6 })
    );
